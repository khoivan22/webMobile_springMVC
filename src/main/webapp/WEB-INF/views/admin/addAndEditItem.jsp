                        ...
                        <div class="col-12 d-flex justify-content-center">
                            <div class="card" style="padding: 20px;width: 50%">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input cssClass="form-control" path="ITEMS_NAME" required="required"/>
                                    <form:errors cssClass="text-danger" path="ITEMS_NAME"/>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#idSupp").keyup(function () {
            var s = $('#idSupp').val()
            $.ajax({
                url: "/web_mobile/admin/managerItem/check",
                type: "get",
                data: {id: s},
                success(check) {
                    var input = $("#text-fail");
