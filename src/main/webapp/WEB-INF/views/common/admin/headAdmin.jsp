<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <!-- General JS Scripts -->
    <script src="<c:url value="/assetAdmin/js/app.min.js"/>"></script>
    <!-- JS Libraies -->
    <%--<script src="<c:url value="/assetAdmin/bundles/apexcharts/apexcharts.min.js"/>"></script>--%>
    <!-- Page Specific JS File -->
    <script src="<c:url value="/assetAdmin/js/page/index.js"/>"></script>
    <!-- Template JS File -->
